            ...
            <div class="row">
                <tr>
                    ...
                    <th style="width: 33%;">
                        <div class="date mb-2">
                            Date:<br>
                            <input id="prescription_date" type="date" value="<?php echo date("Y-m-d") ?>">
                        </div>
                        <div class="patient-id">
                            Prescription ID:<input id="prescription_id" type="text" value= "<?php echo Prescription::get_last_id();?>" size="2">
                        </div>
                    </th>
                </tr>
            </div>
